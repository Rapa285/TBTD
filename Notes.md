...
- unit vision circle unsync (scale the range plane by radius x 2)
- Change colider to tube because of new map y differences
- unit vision only visible when hovered